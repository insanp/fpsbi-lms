<!-- Quiz widget -->
<div class="row text-gray-900" style="margin-bottom: 100px;">
    <div class="col-lg-10">
            ...
            <div class="card-body">
                <div class="row">
                    <div class="col text-justify">
                        ...
                        <br />
                        <p>
                            Untuk membuka topik selanjutnya, silakan selesaikan latihan berikut ini.</p>
                    </div>
                </div>
                <br />
                <hr />
                <div class="row">
                    <div id="quiz-container" class="col text-justify">
                        ...
                        <div id="score-screen" style="display:none;" class="mb-5 mt-4 text-center">
                            ...
                            <div id="retry-task" class="mt-4 text-danger text-center">
                                <p>Anda belum mendapatkan skor penuh. Mohon diulang kembali.</p>
                                <br /><br />
                                <button id="retry-quiz" class="btn btn-success" style="padding: 15px;">Mulai Ulang</button>
                            </div>
...
<script type="text/javascript">
    ...
    function finishQuiz() {
        ...
        document.getElementById('final-score').textContent = correctAnswers + ' dari ' + quizData.questions.length;
        document.getElementById('retry-task').style.display = 'block';
        document.getElementById('completed-task').style.display = 'none';

        if (correctAnswers == quizData.questions.length) {
            document.getElementById('retry-task').style.display = 'none';
