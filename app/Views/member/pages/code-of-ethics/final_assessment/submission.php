...
<div class="container-fluid topic-content-container">
    ...
    <div class="row text-gray-900">
        <div class="col-lg-10 text-center">
            <div class="card shadow mb-4">
                <div class="card-body">
                    <p class="mb-4">Sistem sedang mengevaluasi jawaban Anda. Mohon halaman browser jangan ditutup...</p>
...
<script type="text/javascript">
    ...
    document.addEventListener("DOMContentLoaded", function() {
        window.location.href = "<?= base_url('member/rfp-ins/final-assessment/result') ?>";
    });
</script>
<?= $this->endSection() ?>