...
<div class="container-fluid">
    ...
    <p class="mb-4">Edit User / Member</p>
    <div class="card shadow mb-4 p-4">
        ...
        <form action="<?= base_url('admin/users/update') ?>" method="post">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control form-control-user" name="email" placeholder="email" pattern="[^ @]*@[^ @]*" value="<?= old('email', $user['email']); ?>">
            </div>

            <div class="form-group">
                <label for="member ID">Nama:</label>
                <input type="text" class="form-control form-control-user" name="name" placeholder="nama" value="<?= old('name', $user['name']); ?>">
            </div>
            ...
            <div class="form-group">
                ...
                <input type="checkbox" class="custom-control custom-checkbox small" name="is_active" <?=set_checkbox('is_active', 'on', old('is_active', $user['is_active']) == 1)?>>
            </div>

            <div class="form-group">
                <label for="member ID">Admin:</label>
                <input type="checkbox" class="custom-control custom-checkbox small" name="is_admin" <?=set_checkbox('is_admin', 'on', old('is_admin', $user['is_admin']) == 1)?>>
            </div>
