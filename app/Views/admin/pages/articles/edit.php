    ...
    <div class="card shadow mb-4 p-4">
        ...
        <form action="<?= base_url('admin/articles/update') ?>" method="post">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control form-control-user" name="title" placeholder="Judul" value="<?= old('title', $article['title']); ?>">
            </div>

            <div class="form-group">
                <label for="resume">Resume:</label>
                <textarea name="resume" class="form-control form-control-user"><?= old('resume', $article['resume']); ?></textarea>
            </div>

            <div class="form-group">
                <label for="content">Content:</label>
                <textarea id="editor" name="content" class="form-control form-control-user"><?= old('content', $article['content']); ?></textarea>
            </div>
            ...
            <div class="form-group">
                ...
                <select name="status">
                    ...
                    <option value="delete" <?=(old('status', $article['status']) == 'delete') ? 'selected' : ''?>>Delete</option>
                </select>
            </div>
