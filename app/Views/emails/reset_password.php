            ...
            <td>
                        ...
                        <tr>
                            <td>
                                <table class="row-content stack" align="center" border="0" cellpadding="0" cellspacing="0" role="presentation" style="mso-table-lspace: 0pt; mso-table-rspace: 0pt; border-radius: 0; color: #000000; width: 700px; margin: 0 auto;" width="700">
                                    <tbody>
                                        <tr>
                                            <td class="column column-1" width="100%" style="mso-table-lspace: 0pt; mso-table-rspace: 0pt; font-weight: 400; text-align: left; padding-bottom: 30px; padding-left: 30px; padding-right: 30px; padding-top: 30px; vertical-align: top;">
                                                ...
                                                <table class="paragraph_block block-2" width="100%" border="0" cellpadding="10" cellspacing="0" role="presentation" style="mso-table-lspace: 0pt; mso-table-rspace: 0pt; word-break: break-word;">
                                                    <tbody>
                                                        <tr>
                                                            <td class="pad">
                                                                <div style="color:#10305b;direction:ltr;font-family:'Helvetica Neue', Helvetica, Arial, sans-serif;font-size:18px;font-weight:400;letter-spacing:0px;line-height:1.2;text-align:justify;mso-line-height-alt:22px;">
                                                                    <p style="margin: 0; margin-bottom: 18px;">Kami menerima permintaan untuk mengatur ulang kata sandi akun Anda pada LMS FPSB Indonesia.</p>
                                                                    <p style="margin: 0; margin-bottom: 18px;">Silakan gunakan tautan berikut untuk membuat kata sandi baru:</p>
                                                                    <p style="margin: 0; margin-bottom: 18px;"><a href="<?= $data['link'] ?>" target="_blank"><?= $data['link'] ?></a></p>
                                                                    <p style="margin: 0; margin-bottom: 18px;">Tautan ini hanya berlaku hingga 5 menit sejak email ini dikirimkan. Jika Anda tidak melakukan permintaan ini, mohon abaikan email ini dan akun Anda tetap aman.</p>
                                                                    <p style="margin: 0; margin-bottom: 18px;">Hormat kami,<br>
                                                                        LMS FPSB Indonesia<br></p>
                                                                </div>
                                                            </td>
                                                        </tr>
                                                    </tbody>
                ...
                <table class="row row-3" align="center" width="100%" border="0" cellpadding="0" cellspacing="0" role="presentation" style="mso-table-lspace: 0pt; mso-table-rspace: 0pt;">
                    <tbody>
                        <tr>
                            <td>
                                <table class="row-content stack" align="center" border="0" cellpadding="0" cellspacing="0" role="presentation" style="mso-table-lspace: 0pt; mso-table-rspace: 0pt; background-color: #10305b; color: #000000; border-radius: 0; width: 700px; margin: 0 auto;" width="700">
                                    <tbody>
                                        <tr>
                                            <td class="column column-1" width="100%" style="mso-table-lspace: 0pt; mso-table-rspace: 0pt; font-weight: 400; text-align: left; padding-bottom: 5px; padding-top: 5px; vertical-align: top;">
                                                <table class="paragraph_block block-1" width="100%" border="0" cellpadding="10" cellspacing="0" role="presentation" style="mso-table-lspace: 0pt; mso-table-rspace: 0pt; word-break: break-word;">
                                                    <tbody>
                                                        <tr>
                                                            <td class="pad">
                                                                <div style="color:#ffffff;direction:ltr;font-family:'Helvetica Neue', Helvetica, Arial, sans-serif;font-size:18px;font-weight:400;letter-spacing:0px;line-height:1.2;text-align:center;mso-line-height-alt:22px;">
                                                                    <p style="margin: 0;"><a href="<?= base_url() ?>" target="_blank" style="text-decoration: none; color: #ffffff;" rel="noopener"><?= base_url() ?></a><br></p>
                                                                </div>
                                                            </td>
                                                        </tr>
                                                    </tbody>
